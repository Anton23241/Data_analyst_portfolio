...
| 9.1 | 	[Выпускной проект(AB тестирование)](https://github.com/Anton23241/Data_analyst_portfolio/blob/main/Projects/Проект%209.1%20Выпускной%20проект(AB%20тестирование).ipynb)| Оценить корректность проведения A/B теста и проанализировать результаты теста. | |
| 9.2 | 	[Выпускной проект(SQL)](https://github.com/Anton23241/Data_analyst_portfolio/blob/main/Projects/Проект%209.2%20Выпускной%20проект(SQL).ipynb)| Проанализировать базу данных и выполнить ряд задач | |
